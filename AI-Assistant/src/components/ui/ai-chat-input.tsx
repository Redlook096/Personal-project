...
const DEFAULT_PLACEHOLDERS = [
  ...
  "Generate code, write content, analyze data...",
...
const AIChatInput = ({ onSend, placeholder, disabled = false }: AIChatInputProps) => {
  ...
  return (
    <motion.div
      ref={wrapperRef}
      className="w-full max-w-3xl mx-auto tap-highlight-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
        ...
        <div className="flex items-center gap-2 p-3 rounded-full max-w-3xl w-full">
          ...
          <div className="relative flex-1">
            <input
              ...
              disabled={disabled}
              className="flex-1 border-0 outline-0 rounded-md py-2 text-base bg-transparent w-full font-normal disabled:cursor-not-allowed disabled:opacity-50"
              style={{ position: "relative", zIndex: 1, WebkitTapHighlightColor: "transparent" }}
          ...
          <button
            className="flex items-center gap-1 bg-black hover:bg-zinc-700 text-white p-3 rounded-full font-medium justify-center transition disabled:opacity-50 disabled:cursor-not-allowed"
            title="Send"
            type="button"
            tabIndex={-1}
            onClick={handleSend}
